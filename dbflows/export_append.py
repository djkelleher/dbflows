...
from .export_meta import ExportMeta, create_export_meta
from .utils import copy_to_csv, default_logger, schema_table
...
def export_table(
    ...
    Args:
        ...
        n_workers (Optional[int], optional): Number of export tasks to run simultaneously. Defaults to env var DB_EXPORTS_N_WORKERS or 1.
    """
...
def export(
    ...
    if save_path_name != created_file_name:
        ...
        fo.move(save_path, (save_path := f"{save_path_head}/{created_file_name}"))
...
def export_all(
    ...
    logger.info("Starting exports with %i max workers", n_workers)
